...
public class JobRoleController {
	...
	public ResponseEntity<Map<String, Object>> addOrUpdate(@RequestPart JobRoleDto object) {
		return ResponseEntity.ok(jobRoleService.saveOrUpdate(object));
	}
	
	
	@GetMapping("/getById/{id}")
	public ResponseEntity<JobRoleDto> getByJobRoleById(@PathVariable Long id) {
		return ResponseEntity.ok(this.jobRoleService.getById(id));
	}
	
//	@GetMapping("/list")
//	public ResponseEntity<Map<String, Object>> getJobRoleList(@RequestParam Map<String, Object> params) throws JsonParseException, JsonMappingException, IOException {
//		return ResponseEntity.ok(this.jobRoleService.getJobRoleList(params));
//	}
...
//		int start = (page - 1) * limit;
	...
	public ResponseEntity<Map<String, Object>> getSelectionList() {
		return ResponseEntity.ok(this.jobRoleService.getSelectionList(StatusEnum.Active));
	}
